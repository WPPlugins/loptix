 ...
 * 2019.03.09 - Added Language parameter
 */
...
class Loptix_Widget extends WP_Widget {
	...
	function widget($args, $instance) {
		...
		echo '<div style="text-align:right;font-size:11px;"><a href="http://loptix.com/" target="_blank">Loptix - link sharing system</a></div>';
		echo $after_widget;
	}
	...
	function form($instance) {		
		...
		<p><label for="<?php echo $this->get_field_id('language'); ?>">Language: <select class="widefat" id="<?php echo $this->get_field_id('language'); ?>" name="<?php echo $this->get_field_name('language'); ?>">
			<?
